...
htmlhelp_basename = 'Project-Team-Guidedoc'
...
latex_documents = [
  ('index', 'Project-team-guide.tex', u'Project Team Guide',
...
texinfo_documents = [
  ('index', 'Project-team-guide', u'Project Team Guide',
   u'OpenStack Contributors', 'project-team-guide',
...
epub_title = u'OpenStack Project Team Guide'
